            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{url('admin/category-create')}}">
                                        <i class="fas fa-database"></i>New Category</a>
                                </li>
                            </ul>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{url('admin/all-category')}}">
                                        <i class="fas fa-database"></i>All Category</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="active has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-hdd"></i>Sub Category
                                <span class="arrow">
                                    <i class="fas fa-angle-down"></i>
                                </span>
                            </a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{url('admin/subcategory-create')}}">
                                        <i class="fas fa-database"></i>New Sub Category</a>
                                </li>
                            </ul>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{url('admin/all-subcategory')}}">
                                        <i class="fas fa-database"></i>All Sub Category</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{url('admin/receipe-create')}}">
                                        <i class="fas fa-database"></i>New Receipe</a>
                                </li>
                            </ul>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{url('admin/all-receipe')}}">
                                        <i class="fas fa-database"></i>All Receipe</a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{url('admin/user-create')}}">
                                        <i class="fas fa-database"></i>New User</a>
                                </li>
                            </ul>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{url('admin/all-users')}}">
                                        <i class="fas fa-database"></i>All Users</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="active has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-hdd"></i>Theme Settings
                                <span class="arrow">
                                    <i class="fas fa-angle-down"></i>
                                </span>
                            </a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{url('admin/user-create')}}">
                                        <i class="fas fa-database"></i>Add Sliter</a>
                                </li>
                            </ul>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{url('admin/all-users')}}">
                                        <i class="fas fa-database"></i>All Sliters</a>
                                </li>
                            </ul>
